export const messages = {
  zh: {
    ...
    home: {
      ...
      marketing: {
        topbarLocation: "产品协作 · 在线",
        topbarHours: "Mon - Sat: 9:00 - 22:00",
        topbarEmail: "hello@afterglow.app",
        roadmap: "路线图",
        heroLine1: "从这里开始",
        welcome: "欢迎",
        welcomeHighlight: "更清晰的产品协作",
        ratingTitle: "口碑",
        ratingBased: "基于早期用户反馈",
        readMore: "了解更多",
        sectionAccent: "能力",
        testimonialAuthor: "早期用户",
        testimonialRole: "产品负责人",
        testimonialQuote: "Afterglow 把反馈、讨论和执行串成一条清晰路径，团队对齐成本明显降低。",
        statUsers: "注册用户",
        statPosts: "社区互动",
        statYears: "迭代阶段",
        statModules: "核心模块",
        teamAccent: "模块",
        teamFeed: "社区时间线",
        teamFeedDesc: "发帖、评论与互动",
        teamChat: "私聊",
        teamChatDesc: "会话与实时消息",
        teamMirror: "静一下",
        teamMirrorDesc: "情绪镜像与建议",
        teamRoadmap: "路线图",
        teamRoadmapDesc: "里程碑与交付节奏",
        pricingAccent: "方案",
        faqAccent: "指南",
        footerAbout: "Afterglow（余温）帮助团队把情绪、反馈与产品决策组织成可持续的协作体验。",
    ...
    chat: {
      ...
      reconnectExhausted: "实时连接已断开，请刷新页面或稍后重试",
  ...
  en: {
    ...
    home: {
      ...
      marketing: {
        topbarLocation: "Product collaboration · Online",
        topbarHours: "Mon - Sat: 9:00 AM - 10:00 PM",
        topbarEmail: "hello@afterglow.app",
        roadmap: "Roadmap",
        heroLine1: "Start here",
        welcome: "Welcome",
        welcomeHighlight: "Clearer product collaboration",
        ratingTitle: "Reputation",
        ratingBased: "Based on early user feedback",
        readMore: "Learn more",
        sectionAccent: "Capabilities",
        testimonialAuthor: "Early user",
        testimonialRole: "Product lead",
        testimonialQuote:
          "Afterglow connects feedback, discussion, and execution into one clear path — alignment cost dropped noticeably.",
        statUsers: "Registered users",
        statPosts: "Community interactions",
        statYears: "Iteration stages",
        statModules: "Core modules",
        teamAccent: "Modules",
        teamFeed: "Community feed",
        teamFeedDesc: "Posts, comments, engagement",
        teamChat: "Direct chat",
        teamChatDesc: "Conversations and live messages",
        teamMirror: "Mirror",
        teamMirrorDesc: "Emotion mirror and suggestions",
        teamRoadmap: "Roadmap",
        teamRoadmapDesc: "Milestones and delivery rhythm",
        pricingAccent: "Plans",
        faqAccent: "Guides",
        footerAbout:
          "Afterglow helps teams turn emotion, feedback, and product decisions into a sustainable collaboration experience.",
    ...
    chat: {
      ...
      reconnectExhausted: "Live connection lost. Refresh the page or try again later.",
